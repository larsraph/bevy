    ...
    pub async fn load_gltf<'a, 'b, 'c>(
        ...
        for gltf_mesh in gltf.meshes() {
            ...
            for primitive in gltf_mesh.primitives() {
                ...
                let mut user_mesh: Option<UMesh> = None;
                for extension in extensions.iter_mut() {
                    extension
                        .on_gltf_primitive(
                            load_context,
                ...
                if mesh.get_attribute(Mesh::ATTRIBUTE_NORMAL).is_none()
                    && matches!(mesh.meta(), PrimitiveTopology::TriangleList)
                {
                    tracing::debug!(
                ...
                let mesh_handle =
                    load_context.add_labeled_asset(primitive_label.to_string(), mesh.asset());
